...
```bash
# Apple Silicon
wget https://github.com/carlomagnoglobal/toMarkdown-viewer/releases/download/gui-v0.6.4/toMarkdown.Viewer_0.6.4_aarch64.dmg
open toMarkdown.Viewer_0.6.4_aarch64.dmg

# Intel
wget https://github.com/carlomagnoglobal/toMarkdown-viewer/releases/download/gui-v0.6.4/toMarkdown.Viewer_0.6.4_x64.dmg
open toMarkdown.Viewer_0.6.4_x64.dmg
```
...
`toMarkdown.Viewer_0.6.4_x64-setup.exe` (or the `.msi`).
