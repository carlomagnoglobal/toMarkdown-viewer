...
fn build_menu(app: &tauri::AppHandle) -> tauri::Result<tauri::menu::Menu<tauri::Wry>> {
    ...
    let view = Submenu::with_items(app, "View", true, &[
        ...
        &MenuItem::with_id(app, "theme-rose", "Theme: Rose", true, None::<&str>)?,
        &MenuItem::with_id(app, "theme-blue", "Theme: Blue", true, None::<&str>)?,
        &MenuItem::with_id(app, "theme-darkblue", "Theme: Dark Blue", true, None::<&str>)?,
        &MenuItem::with_id(app, "theme-lightblue", "Theme: Light Blue", true, None::<&str>)?,
        &MenuItem::with_id(app, "theme-green", "Theme: Green", true, None::<&str>)?,
        &MenuItem::with_id(app, "theme-darkgreen", "Theme: Dark Green", true, None::<&str>)?,
        &MenuItem::with_id(app, "theme-lightgreen", "Theme: Light Green", true, None::<&str>)?,
        &MenuItem::with_id(app, "theme-gold", "Theme: Gold", true, None::<&str>)?,
        &MenuItem::with_id(app, "theme-silver", "Theme: Silver", true, None::<&str>)?,
        &MenuItem::with_id(app, "theme-darkrose", "Theme: Dark Rose", true, None::<&str>)?,
        &MenuItem::with_id(app, "theme-darkgold", "Theme: Dark Gold", true, None::<&str>)?,
        &MenuItem::with_id(app, "theme-darksilver", "Theme: Dark Silver", true, None::<&str>)?,
        &MenuItem::with_id(app, "theme-blacksilver", "Theme: Black Silver", true, None::<&str>)?,
    ])?;
